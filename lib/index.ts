...
export class TuioClient {
  ...
  process2DCursor(packet: TuioPacket, message: TuioSourceMessage | TuioAliveMessage | TuioSetMessage | TuioFseqMessage) {
    switch (message.type) {
      case 'source':
  ...
  process2DObject(packet: TuioPacket, message: TuioSourceMessage | TuioAliveMessage | TuioSetMessage | TuioFseqMessage) {
    switch (message.type) {
      case 'source':
        packet.source = message.address || '';
        this.ensureArraysAreInitialized(packet.source);
